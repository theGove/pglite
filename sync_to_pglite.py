...
from blogger_client_2 import publish

ROOT = Path(__file__).resolve().parent

POSTS = {
    "app.js": ("617114046887403901", ROOT / "app.js"),
    "styles.css": ("5411693192985744516", ROOT / "styles.css"),
    "index.html": ("3350942622867096583", ROOT / "index.html"),
}
